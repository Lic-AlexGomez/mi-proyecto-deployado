...
from flask_bcrypt import Bcrypt  # type: ignore # para encriptar y comparar
from flask import Flask, request, jsonify # type: ignore # Para endpoints
from flask_sqlalchemy import SQLAlchemy  # type: ignore # Para rutas
from flask_jwt_extended import  JWTManager, create_access_token, jwt_required, get_jwt_identity # type: ignore
from admin_bp import admin_bp                       # type: ignore # Acá importamos rutas admin
from public_bp import public_bp                     # type: ignore # Acá importamos rutas public
from database import db                             # type: ignore # Acá importamos la base de datos inicializada
